...
echo "
VITE_SERVER_URL=https://api.demo.srv829422.hstgr.cloud
" > .env
...
ssh -p 65002 u371241921@147.93.101.85 "rm -rf /home/u371241921/domains/topgrowth.in/public_html/bm/assets"

# 5. Upload contents of 'dist' directly into 'Business management (bm)' directory
# remove logo.jpeg from dist folder
rm dist/logo.jpeg
scp -P 65002 -r dist/* u371241921@147.93.101.85:/home/u371241921/domains/topgrowth.in/public_html/bm
