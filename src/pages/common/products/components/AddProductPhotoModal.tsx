...
const AddProductPhotoModal = ({ product, open, onClose, onSuccess }: AddProductPhotoModalProps) => {
    const { mutateAsync: uploadPhoto, isPending: isUploading } = useUploadProductPhoto();
