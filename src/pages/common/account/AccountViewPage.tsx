...
import { ArrowLeft, Search, Landmark, User, Hash, MapPin, IndianRupee } from "lucide-react";
...
const AccountViewPage = () => {
    ...
    const columns: Column<typeof DUMMY_TRANSACTIONS[0]>[] = [
        ...
        },
        {
            ...
            header: "Type",
            render: (item) => (
                <Badge variant={item.type === "credit" ? "success" : "destructive"} className="uppercase text-[10px]">
                    {item.type}
                </Badge>
            ),
        },
        {
            ...
            sortable: true,
            render: (item) => (
                <span className={`font-semibold ${item.type === "credit" ? "text-green-600" : "text-red-600"}`}>
        ...
        <div className="w-full mx-auto space-y-6 animate-fade-in pb-10">
            ...
            <div className="flex items-center justify-between border-b border-border pb-4">
                <div className="flex items-center gap-4">
                    <Button variant="outline" size="icon" className="h-8 w-8 rounded-sm" onClick={() => navigate(-1)}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="font-bold text-sm">{account.accountHolderName || "-"}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="font-bold text-sm font-mono">{account.accountNumber || "-"}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs text-muted-foreground uppercase font-semibold">Branch & IFSC</p>
                            <p className="font-bold text-sm">{account.branchName || "-"}</p>
                            <p className="text-[11px] text-muted-foreground font-mono">{account.ifscCode || "-"}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs text-muted-foreground uppercase font-semibold">UPI ID</p>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="font-bold text-xl text-primary">
                                ₹{Number(account.openingBalance || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                            </p>
                        </div>
                    </div>
                </div>
