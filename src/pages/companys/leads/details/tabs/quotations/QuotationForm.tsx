                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <Badge
                          ...
                          className={cn(
                            ...
                            uiStatusLabel.includes("Rejected") ||
                              uiStatusLabel === "Cancelled"
                              ? "border-destructive text-destructive"
                              : uiStatusLabel.includes("Approved") ||
                                  uiStatusLabel === "Accepted"
                      ...
                      <FormItem className="space-y-1">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            type="number"
                            step="0.01"
                            className="pl-9 h-10 text-lg font-black tracking-tight rounded-sm"
                            {...field}
                            value={field.value || ""}
                            onChange={(e) =>
                  ...
                  {taxFields.map((field, index) => (
                    ...
                    >
                      ...
                      <Input
                        ...
                        {...form.register(
                          `tax_details.${index}.value` as const,
                        )}
                        onChange={(e) =>
                          form.setValue(
