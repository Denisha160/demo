        ...
        <div className="w-full mx-auto space-y-4 animate-fade-in pb-10">
            ...
            {filteredAccounts.length > 0 ? (
                        ...
                        >
                            ...
                            <div className="p-5 flex-1 space-y-4">
                                <div className="flex items-start justify-between">
                                    <Badge variant={account.isActive ? "success" : "secondary"} className="rounded-full px-2 py-0 text-[10px] uppercase tracking-wider font-bold">
                                ...
                                <div className="pt-3 border-t border-border/50">
                                    <p className="text-[9px] text-muted-foreground uppercase font-bold tracking-widest">Opening Balance</p>
                            ...
                            <div className="px-5 py-3 bg-muted/20 border-t border-border flex items-center justify-between z-10">
                                <Button
                                    ...
                                    onClick={(e) => { e.stopPropagation(); navigate(account.id); }}
                                >
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    <Button
                                        ...
                                        onClick={(e) => { e.stopPropagation(); setAccounts(accounts.filter(a => a.id !== account.id)); }}
                                    >
                ...
                <div className="flex flex-col items-center justify-center py-20 border-2 border-dashed border-border rounded-2xl bg-muted/5">
                    ...
                    <h3 className="text-lg font-bold text-foreground">No accounts found</h3>
                    ...
                    <Button className="mt-6 gap-2 font-semibold text-xs h-9" onClick={handleCreateNew}>
