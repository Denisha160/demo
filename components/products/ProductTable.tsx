      ...
      {products.map((product) => (
        ...
        >
          ...
          <Link
            ...
            className="relative block overflow-hidden bg-gray-50 dark:bg-gray-800"
          ...
          <div className="flex flex-col flex-1 p-3 gap-1">
            ...
            <div className="flex items-center justify-between mt-auto pt-2 border-t border-gray-100 dark:border-white/5">
              ...
              <div
                className={`w-2.5 h-2.5 rounded-full flex-shrink-0 ${product.stock > 10 ? "bg-green-500" : "bg-amber-400"}`}
            ...
            <div className="flex gap-1.5 mt-2">
              <button
                ...
                className="cursor-pointer flex-1 py-1.5 text-[11px] font-bold text-white bg-pink-600 hover:bg-pink-700 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 shadow-sm"
              >
              ...
              <button
                ...
                disabled={updatingId === product.id}
                className="cursor-pointer flex-1 py-1.5 text-[11px] font-bold text-white bg-red-500 hover:bg-red-600 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 shadow-sm"
              >
                Delete
              </button>
            </div>
