        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5 sm:col-span-2">
            ...
            <div className="relative">
              <CreditCard
                className={`absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 ${errors.accountName ? "text-destructive" : "text-muted-foreground/60"}`}
              />
              <Input
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <User
                className={`absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 ${errors.accountHolderName ? "text-destructive" : "text-muted-foreground/60"}`}
              />
              <Input
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <Hash
                className={`absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 ${errors.accountNumber ? "text-destructive" : "text-muted-foreground/60"}`}
              />
              <Input
          ...
          <div className="space-y-1.5">
            ...
            >
              <SelectTrigger
                className={`h-9 ${errors.accountType ? "border-destructive focus:ring-destructive/20" : "border-border"}`}
              >
          ...
          <div className="space-y-1.5 xs:col-span-1">
            ...
            <div className="relative">
              <Landmark
                className={`absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 ${errors.bankName ? "text-destructive" : "text-muted-foreground/60"}`}
              />
              <Input
                {...register("bankName")}
          ...
          <div className="space-y-1.5 xs:col-span-1">
            ...
            <div className="relative">
              <MapPin
                className={`absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 ${errors.branchName ? "text-destructive" : "text-muted-foreground/60"}`}
              />
              <Input
                {...register("branchName")}
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <Hash
                className={`absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 ${errors.ifscCode ? "text-destructive" : "text-muted-foreground/60"}`}
              />
              <Input
                {...register("ifscCode")}
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <Hash
                className={`absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 ${errors.upiId ? "text-destructive" : "text-muted-foreground/60"}`}
              />
              <Input
                {...register("upiId")}
          ...
          <div className="space-y-1.5 sm:col-span-2">
            ...
            <div className="relative">
              <IndianRupee
                className={`absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 ${errors.openingBalance ? "text-destructive" : "text-muted-foreground/60"}`}
              />
              <Input
                type="number"
                step="any"
