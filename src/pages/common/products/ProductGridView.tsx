...
const ProductGridView = ({
  ...
  return (
    <TooltipProvider>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 3xl:grid-cols-7 gap-3 p-1 animate-in fade-in duration-500">
        {items.map((product) => (
          <Card
            key={product.id}
