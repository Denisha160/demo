...
const QuotationForm = ({
  ...
  const handleContactChange = (contactId: string) => {
    ...
    if (contact) {
      ...
      form.setValue("contact_person_name", contact.name || "", {
        shouldValidate: true,
      });
      form.setValue("contact_person_designation", contact.designation || "", {
        shouldDirty: true,
      });
      form.setValue("contact_person_email", contact.email || "", {
        shouldDirty: true,
      });
      form.setValue("contact_person_phone", contact.phone || "", {
        shouldDirty: true,
      });
    }
  };
  ...
  const totals = useMemo(() => {
    ...
    const discAmount =
      watchAll.discount_type === "PERCENTAGE"
        ? (sub * discVal) / 100
        : watchAll.discount_type === "FIXED"
          ? discVal
          : 0;

    const taxable = Math.max(sub - discAmount, 0);
    const taxTotal = (watchAll.tax_details || []).reduce(
      (s, t) => s + (Number(t.value) || 0),
      0,
    );
    const chargesTotal =
      (watchAll.additional_charges || []).reduce(
        (s, c) => s + (Number(c.value) || 0),
        0,
      ) + (Number(watchAll.delivery_charges) || 0);
    ...
    watchAll.tax_details,
    watchAll.additional_charges,
    watchAll.delivery_charges,
  ]);
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-1">
                      ...
                      <DatePicker
                        ...
                        className="h-8 rounded-sm text-xs border-border/60"
                      />
                      <FormMessage className="text-[10px]" />
                    </FormItem>
                  )}
                    ...
                    <FormItem className="space-y-1">
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="h-8 text-xs font-medium border-border/60 rounded-sm"
                          {...field}
                        />
                      </FormControl>
                    </FormItem>
            ...
            <div className="space-y-2 pt-2">
              ...
              <div className="space-y-2">
                {taxFields.map((field, index) => (
                  <div
                    key={field.id}
                    className="flex gap-2 items-start animate-in slide-in-from-right-1"
                  >
                    <Input
                      placeholder="Tax Name"
                      className="h-8 text-xs flex-1 rounded-sm border-border/60"
                      {...form.register(`tax_details.${index}.key` as const)}
                    />
                    <Input
                      type="number"
                      placeholder="0.00"
                      className="h-8 text-xs w-[100px] rounded-sm border-border/60"
                      {...form.register(`tax_details.${index}.value` as const)}
                      onChange={(e) =>
                        form.setValue(
                          `tax_details.${index}.value`,
              ...
              <div className="space-y-2">
                <div className="flex gap-2 items-start bg-muted/20 p-1 rounded-md">
                  ...
                  <Input
                    type="number"
                    placeholder="0.00"
                    className="h-8 text-xs w-[100px] bg-background"
                    {...form.register(`delivery_charges` as const)}
                    onChange={(e) =>
                      form.setValue(`delivery_charges`, Number(e.target.value))
                    }
                  />
                  <div className="w-8" />
                </div>
                {chargeFields.map((field, index) => (
                  ...
                  >
                    <Input
                      ...
                      className="h-8 text-xs flex-1 rounded-sm border-border/60"
                      {...form.register(
                        `additional_charges.${index}.key` as const,
                      )}
                    />
                    <Input
                      type="number"
                      ...
                      className="h-8 text-xs w-[100px] rounded-sm border-border/60"
                      {...form.register(
                        `additional_charges.${index}.value` as const,
                      )}
                      onChange={(e) =>
                        form.setValue(
                          `additional_charges.${index}.value`,
                          Number(e.target.value),
                        )
                      }
                    />
                      ...
                      <FormItem className="space-y-1">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            type="number"
                            step="0.01"
                            className="pl-9 h-10 text-lg font-black tracking-tight rounded-sm bg-muted/20 border-border/30"
                            {...field}
                            value={field.value || ""}
                            readOnly
                          />
                        ...
                        <FormItem className="space-y-1">
                          ...
                          <FormControl>
                            <Input
                              ...
                              step="0.01"
                              placeholder="0.00"
                              className="h-8 text-xs font-medium border-border/60 bg-background rounded-sm"
                              {...field}
                              value={field.value || ""}
                              onChange={(e) =>
          ...
          <div className="space-y-3">
                  ...
                  <FormItem className="space-y-1">
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        className="min-h-[60px] text-xs resize-none rounded-sm border-border/60"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage className="text-[10px]" />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-1 animate-in slide-in-from-top-2">
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Why was this rejected by the customer?"
                          className="min-h-[60px] text-xs border-destructive/30 rounded-sm"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage className="text-[10px]" />
                    ...
                    <FormItem className="space-y-1 animate-in slide-in-from-top-2">
                      ...
                      <FormControl>
                        <Textarea
                          ...
                          className="min-h-[60px] text-xs border-orange-300 rounded-sm"
                          {...field}
                        />
                      </FormControl>
                      <FormMessage className="text-[10px]" />
                      ...
                      <FormItem className="space-y-1">
                        ...
                        <FormControl>
                          <Input
                            ...
                            className="h-8 text-xs border-border/60 rounded-sm"
                            {...field}
                          />
                        </FormControl>
                      </FormItem>
            ...
            <div className="space-y-4 pt-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="space-y-1">
                          ...
                          <FormControl>
                            <Input
                              placeholder="Notes for/from approver..."
                              className="h-8 text-xs border-border/60 rounded-sm"
                              {...field}
                            />
                          </FormControl>
              ...
              {(watchAll.status === "ACCEPTED" ||
                watchAll.approval_status === "APPROVED") && (
                <div className="grid grid-cols-2 gap-2 p-2 rounded-sm border border-primary/20 bg-primary/5 animate-in slide-in-from-bottom-2">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm font-bold truncate">
                      {watchAll.status === "ACCEPTED"
                        ? watchAll.accepted_by || "System"
                        : watchAll.approved_by || "Pending"}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-[10px] font-black uppercase text-primary/70">
                    ...
                    <p className="text-sm font-bold">
                      {watchAll.status === "ACCEPTED"
                        ? watchAll.accepted_at
                          ? formatDate(new Date(watchAll.accepted_at))
                          : "-"
                        : watchAll.approved_at
                          ? formatDate(new Date(watchAll.approved_at))
                          : "-"}
                    </p>
                  </div>
                </div>
