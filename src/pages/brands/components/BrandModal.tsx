...
const BrandModal = ({
    ...
    const handleSave = async () => {
        try {
            ...
            if (error instanceof z.ZodError) {
                ...
                // Handle API error
                const apiError = (error as { response?: { data?: { code?: string; message?: string } }; message?: string; code?: string })?.response?.data || error as { code?: string; message?: string };
    ...
    return (
        <Modal
            ...
            description={isEditing ? "Modify the brand details." : "Create a new brand for your products."}
            footer={
                <>
                    <Button
                        variant="outline"
        ...
        >
            <div className="space-y-4">
                ...
                <div className="grid gap-2">
                    ...
                    <Input
                        placeholder="e.g. Basalt Premium"
                        value={formData.name || ""}
                        onChange={(e) => {
