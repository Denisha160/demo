            ...
            <div className="w-full max-w-md bg-white dark:bg-gray-900 rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-gray-200 dark:border-white/10">
                <div className="p-6 md:p-8">
                    <div className="flex justify-between items-start mb-2">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Update Title</h2>
                        <button
                            onClick={onClose}
                    ...
                    <form onSubmit={onSubmit} className="space-y-6">
                        <div>
                            <label htmlFor="new-title" className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">
                                New Product Title
                            </label>
                            <input
                                id="new-title"
                        ...
                        <div className="flex gap-3 pt-2">
                            ...
                            <button
                                type="submit"
                                disabled={isPending || tempTitle === product?.title || !tempTitle.trim()}
