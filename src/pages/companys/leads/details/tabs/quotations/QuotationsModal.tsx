...
import { useFieldArray, useForm, useWatch, UseFormSetError } from "react-hook-form";
import { z } from "zod";
...
const quotationSchema = z
    .object({
        quotation_number: z.string().min(1, "Quotation number is required").max(50, "Maximum 50 characters"),
        quotation_date: z.string().min(1, "Quotation date is required"),
        valid_until: optionalText,
        status: z.enum(quotationStatuses),

        customer_name: z.string().min(1, "Customer name is required").max(255, "Maximum 255 characters"),
    ...
    .superRefine((data, ctx) => {
        ...
        if (data.expected_delivery_date && data.quotation_date && data.expected_delivery_date < data.quotation_date) {
            ctx.addIssue({
                code: z.ZodIssueCode.custom,
...
const toSafeNumber = (value?: number) => (typeof value === "number" && !Number.isNaN(value) ? value : 0);
...
const QuotationModal = ({
    ...
    const additionalCharges = useWatch({ control: form.control, name: "additional_charges" });
    const deliveryCharges = useWatch({ control: form.control, name: "delivery_charges" });
    ...
    const totalTaxAmount = useMemo(
        () => (taxDetails || []).reduce((sum, item) => sum + toSafeNumber(item?.value), 0),
        [taxDetails]
    );

    const totalAdditionalCharges = useMemo(
        () =>
            (additionalCharges || []).reduce((sum, item) => sum + toSafeNumber(item?.value), 0) + toSafeNumber(deliveryCharges),
    ...
    useEffect(() => {
        form.setValue("total_additional_charges", Number(totalAdditionalCharges.toFixed(2)), {
            shouldDirty: true,
            shouldValidate: false,
        });
            ...
            footer={
                <div className="flex justify-end gap-2 w-full">
                    ...
                    >
                        ...
                        {isSubmitting ? (quotationData ? "Updating..." : "Creating...") : (quotationData ? "Update Quotation" : "Create Quotation")}
                    </Button>
                </div>
            }
        >
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="max-h-[75vh] space-y-5 overflow-y-auto pr-2 pt-2">
                                ...
                                <FormItem className="md:col-span-2">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button
                                            ...
                                            disabled={isSubmitting}
                                            onClick={() => form.setValue("quotation_number", createQuotationNumber(), { shouldDirty: true })}
                                        >
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs font-bold">Valid Until</FormLabel>
                                    <FormControl>
                                        <DatePicker
                                            value={field.value}
                                            onChange={(value) => field.onChange(value || "")}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-xs font-bold">Expected Delivery Date</FormLabel>
                                    <FormControl>
                                        <DatePicker
                                            value={field.value}
                                            onChange={(value) => field.onChange(value || "")}
                    ...
                    <div className="rounded-md border p-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="Customer name" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Customer Email</FormLabel>
                                        <FormControl>
                                            <Input placeholder="Customer email" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Customer Phone</FormLabel>
                                        <FormControl>
                                            <Input placeholder="Customer phone" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Customer GST</FormLabel>
                                        <FormControl>
                                            <Input placeholder="Customer GST" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Customer PAN</FormLabel>
                                        <FormControl>
                                            <Input placeholder="Customer PAN" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="md:col-span-2">
                                        <FormLabel className="text-xs font-bold">Customer Address</FormLabel>
                                        <FormControl>
                                            <Textarea
                    ...
                    <div className="rounded-md border p-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Contact Person ID</FormLabel>
                                        <FormControl>
                                            <Input placeholder="UUID" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="Contact person name" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Contact Person Email</FormLabel>
                                        <FormControl>
                                            <Input placeholder="Contact email" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Contact Person Phone</FormLabel>
                                        <FormControl>
                                            <Input placeholder="Contact phone" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="Designation" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                    ...
                    <div className="rounded-md border p-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Discount Type</FormLabel>
                                        <Select
                        ...
                        <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-4">
                            <div className="rounded-md bg-muted/40 p-3">
                                <p className="text-[10px] uppercase text-muted-foreground">Discount Amount</p>
                                <p className="mt-1 text-sm font-semibold">{renderCurrencyValue(discountAmount)}</p>
                            </div>
                            <div className="rounded-md bg-muted/40 p-3">
                                <p className="text-[10px] uppercase text-muted-foreground">Taxable Amount</p>
                                <p className="mt-1 text-sm font-semibold">{renderCurrencyValue(taxableAmount)}</p>
                            </div>
                            <div className="rounded-md bg-muted/40 p-3">
                                <p className="text-[10px] uppercase text-muted-foreground">Total Tax</p>
                                <p className="mt-1 text-sm font-semibold">{renderCurrencyValue(totalTaxAmount)}</p>
                            </div>
                            <div className="rounded-md bg-primary/10 p-3">
                                <p className="text-[10px] uppercase text-muted-foreground">Grand Total</p>
                                <p className="mt-1 text-sm font-semibold">{renderCurrencyValue(grandTotal)}</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-5 space-y-4">
                            ...
                            {taxFields.length === 0 ? (
                                <p className="text-xs text-muted-foreground">No tax rows added.</p>
                            ) : (
                                <div className="space-y-3">
                                    {taxFields.map((item, index) => (
                                        <div key={item.id} className="grid grid-cols-1 gap-3 md:grid-cols-[1fr_180px_44px]">
                                            <FormField
                                                control={form.control}
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <FormControl>
                                                            <Input placeholder="Tax name" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                                        </FormControl>
                                                        <FormMessage className="text-[10px]" />
                                                    </FormItem>
                                                )}
                        ...
                        <div className="mt-5 space-y-4">
                            ...
                            {chargeFields.length === 0 ? (
                                <p className="text-xs text-muted-foreground">No additional charge rows added.</p>
                            ) : (
                                <div className="space-y-3">
                                        ...
                                        <div key={item.id} className="grid grid-cols-1 gap-3 md:grid-cols-[1fr_180px_44px]">
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <FormControl>
                                                            <Input placeholder="Charge name" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                                        </FormControl>
                                                        <FormMessage className="text-[10px]" />
                                                    </FormItem>
                                                )}
                        ...
                        <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Delivery Charges</FormLabel>
                                        <FormControl>
                                            <Input
                                                type="number"
                                                min="0"
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Total Tax Amount</FormLabel>
                                        <FormControl>
                                            <Input className="h-9 text-xs bg-muted/60" readOnly value={field.value ?? 0} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Total Additional Charges</FormLabel>
                                        <FormControl>
                                            <Input className="h-9 text-xs bg-muted/60" readOnly value={field.value ?? 0} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                    ...
                    <div className="rounded-md border p-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Payment Terms</FormLabel>
                                        <Select
                                            onValueChange={(value) => field.onChange(value === "NONE" ? undefined : value)}
                                            value={field.value ?? "NONE"}
                                            disabled={isSubmitting}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Payment Terms Custom</FormLabel>
                                        <FormControl>
                                            <Input placeholder="Custom payment terms" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Delivery Terms</FormLabel>
                                        <Select
                                            onValueChange={(value) => field.onChange(value === "NONE" ? undefined : value)}
                                            value={field.value ?? "NONE"}
                                            disabled={isSubmitting}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Delivery Terms Custom</FormLabel>
                                        <FormControl>
                                            <Input placeholder="Custom delivery terms" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="md:col-span-2">
                                        <FormLabel className="text-xs font-bold">Delivery Address</FormLabel>
                                        <FormControl>
                                            <Textarea
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="md:col-span-2">
                                        <FormLabel className="text-xs font-bold">Amount In Words</FormLabel>
                                        <FormControl>
                                            <Textarea
                    ...
                    <div className="rounded-md border p-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-row items-center gap-3 rounded-md border p-3 md:col-span-2">
                                        ...
                                        <div>
                                            <FormLabel className="text-xs font-bold">Requires Approval</FormLabel>
                                            <p className="text-[10px] text-muted-foreground">Enable this checkbox if this quotation needs approval.</p>
                                        </div>
                                    </FormItem>
                                )}
                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Approval Status</FormLabel>
                                        <FormControl>
                                            <Input placeholder="Approval status" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Approved By</FormLabel>
                                        <FormControl>
                                            <Input placeholder="User ID" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Approved At</FormLabel>
                                        <FormControl>
                                            <DatePicker
                                                value={field.value}
                                                onChange={(value) => field.onChange(value || "")}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Accepted At</FormLabel>
                                        <FormControl>
                                            <DatePicker
                                                value={field.value}
                                                onChange={(value) => field.onChange(value || "")}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Accepted By</FormLabel>
                                        <FormControl>
                                            <Input placeholder="User ID" className="h-9 text-xs" disabled={isSubmitting} {...field} />
                                        </FormControl>
                                        <FormMessage className="text-[10px]" />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Rejected Reason</FormLabel>
                                        <FormControl>
                                            <Textarea
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-xs font-bold">Cancelled Reason</FormLabel>
                                        <FormControl>
                                            <Textarea
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="md:col-span-2">
                                        <FormLabel className="text-xs font-bold">Approval Remarks</FormLabel>
                                        <FormControl>
                                            <Textarea
