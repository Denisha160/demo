...
import { createPackage, listPackages, updatePackage, getPackageDetails, deletePackage } from '@/services/api';
import type { PackageCreatePayload, PackageUpdatePayload, ApiErrorResponse, PackageType, PackageListResponse, ApiResponse } from '@/types/packages';
...
export function usePackages(params?: Record<string, unknown>) {
    return useQuery<PackageListResponse>({
        ...
        queryFn: async () => {
            const response = await listPackages(params) as ApiResponse<PackageListResponse>;
...
export function usePackagesCombobox(filters?: Record<string, unknown>) {
    return useQuery<PackageType[]>({
        ...
        queryFn: async () => {
            const response = await listPackages({ ...filters, combobox: true }) as ApiResponse<PackageListResponse>;
...
export function usePackage(id?: string) {
    return useQuery<PackageType | null>({
        ...
        queryFn: async () => {
            ...
            const response = await getPackageDetails(id) as ApiResponse<{ package: PackageType }>;
...
export function useCreatePackage() {
    ...
    return useMutation<CreatePackageResponse, ApiErrorResponse, PackageCreatePayload>({
...
export function useUpdatePackage() {
    ...
    return useMutation<UpdatePackageResponse, ApiErrorResponse, PackageUpdatePayload>({
