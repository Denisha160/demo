...
const HierarchyPage = () => {
    ...
    items.forEach((item: any) => {
      ...
      n[nodeId] = {
        ...
        employeeCode: item.user_id
          ? item.user_employee_code || null
          : item.parent_employee_code || null,
        imageUrl: item.user_id
          ? item.user_image_url || null
          : item.parent_image_url || null,
  ...
  const handleCreateNode = async (parentId?: string) => {
    ...
    const parentUserId =
      targetParentId === "root" ? null : nodes[targetParentId]?.userId;
