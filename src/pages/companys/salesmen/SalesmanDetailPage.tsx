        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] text-muted-foreground mt-1">
              {salesman.name} • {salesman.region} Region
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            ...
            <StatCard
              title="Open Leads"
              value="12"
              change="4 nearing deadline"
              icon={<Target className="h-4 w-4" />}
              changeType="negative"
            />
            <StatCard
              title="Quota attainment"
              value={salesman.attainment}
          ...
          <div className="p-5 border border-border rounded-sm bg-card shadow-sm">
            <div className="flex items-center justify-between mb-8 pb-2 border-b border-border/50">
              <h3 className="text-[10px] font-bold text-foreground uppercase tracking-[0.2em] flex items-center gap-2">
                <PieChart className="h-3 w-3 text-primary" /> Lead Stage
                Distribution
              </h3>
            </div>
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="grid grid-cols-1 gap-y-2 w-full md:w-1/2">
                {leadConversionData.map((s) => (
                  <div
                    key={s.name}
                    className="flex items-center justify-between p-2 rounded-sm bg-muted/10 border border-border/30"
                  >
                    <div className="flex items-center gap-2">
                      <div
