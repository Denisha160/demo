export const queryKeys = {
    ...
    leads: {
        ...
        followUps: (leadId: string, filters?: Record<string, unknown>) => [...queryKeys.leads.detail(leadId), 'follow-ups', filters] as const,
        tasks: (leadId: string, filters?: Record<string, unknown>) => [...queryKeys.leads.detail(leadId), 'tasks', filters] as const,
        visits: (leadId: string, filters?: Record<string, unknown>) => [...queryKeys.leads.detail(leadId), 'visits', filters] as const,
        reminders: (leadId: string, filters?: Record<string, unknown>) => [...queryKeys.leads.detail(leadId), 'reminders', filters] as const,
