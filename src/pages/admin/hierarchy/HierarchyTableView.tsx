...
const NestedHierarchyRow = ({
  ...
  return (
    <AccordionItem value={node.id} className="border-none relative">
      <div
        className={cn(
          "flex items-center justify-between px-5 py-3 hover:bg-muted/5 transition-colors group border-b border-border/40",
      ...
      >
        ...
        <div className="flex items-center gap-4 md:gap-8 shrink-0 ml-4 pr-6">
          ...
          <div className="hidden md:flex flex-col items-center w-10">
            <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-tight text-center">
              Team
            </p>
          ...
          <div className="hidden sm:flex flex-col items-end w-[130px]">
            ...
            <p className="text-xs font-bold text-primary italic leading-none truncate w-full text-right mt-1">
              {node.relation || "Reports To"}
            </p>
          </div>
        </div>
      </div>
          ...
          {isEditing && (
            <div className="flex flex-col sm:flex-row items-center gap-3 p-3 bg-muted/10 border-b border-border/40 animate-in slide-in-from-top-2">
              <Combobox
                ...
                placeholder="Re-select user..."
                className="h-8 w-full sm:w-[200px] text-xs shadow-xs"
              />
              <Input
              ...
              <div className="flex items-center gap-2">
                <Button
                  size="sm"
                  className="h-8 shadow-xs text-[10px] font-bold uppercase tracking-tight"
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-8 px-3 text-[10px] font-bold uppercase tracking-tight"
          ...
          {isAddingHere && (
            <div className="flex flex-col sm:flex-row items-center gap-3 p-3 bg-primary/5 border-b border-border/40 animate-in slide-in-from-top-2">
              ...
              <Input
                ...
                className="h-8 text-xs bg-background w-full sm:w-[150px]"
              />
              <div className="flex items-center gap-2">
                <Button
                  size="sm"
