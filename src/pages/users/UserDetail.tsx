...
const UserDetailPage = () => {
        ...
        if (fetchedUser && fetchedUser.id) {
            ...
            setUserData((prev: UserDetailData) => {
                const newData: UserDetailData = {
                    ...
                    date_of_joining: apiUser.date_of_joining ? apiUser.date_of_joining.split('T')[0] : "",
                    ...
                    date_of_birth: apiUser.date_of_birth ? apiUser.date_of_birth.split('T')[0] : "",
                    marital_status: apiUser.marital_status || "single",
                    anniversary_date: apiUser.anniversary_date ? apiUser.anniversary_date.split('T')[0] : "",
    ...
    const workShiftOptions: SelectOption[] = [
        { label: "Morning", value: "morning" }, { label: "Evening", value: "evening" },
        { label: "Night", value: "night" }, { label: "Rotating", value: "rotating" }
    ];
